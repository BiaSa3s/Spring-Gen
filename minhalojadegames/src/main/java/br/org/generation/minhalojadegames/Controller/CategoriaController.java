...
public ResponseEntity<List<Categoria>>getByJogo(@PathVariable String jogo){
	return ResponseEntity.ok(categoriaRepository.findAllByJogoContainingIgnoreCase(jogo));
}
@PostMapping
