...
import br.org.generation.minhalojadegames.model.Usuario_Login;
...
public class UsuarioController {
	...
	@PostMapping("/logar")
	public ResponseEntity<Usuario_Login> login(@RequestBody Optional<Usuario_Login> usuario_Login){
		return usuarioService.autenticarUsuario(usuario_Login)
				.map(resposta -> ResponseEntity.status(HttpStatus.OK).body(resposta))
